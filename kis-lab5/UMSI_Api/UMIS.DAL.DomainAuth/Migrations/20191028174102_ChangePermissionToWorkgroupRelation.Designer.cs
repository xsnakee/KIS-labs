...
namespace UMIS.DAL.DomainAuth.Migrations
{
    ...
    [Migration("20191028174102_ChangePermissionToWorkgroupRelation")]
    partial class ChangePermissionToWorkgroupRelation
    {
            ...
            modelBuilder.Entity("UMIS.DAL.Domain.Contracts.Models.Auth.Role", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, ConcurrencyStamp = "b9e3ccce-01aa-468b-9059-8bfb7fc9047c", CreateDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsSystem = true, LastModificationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "Администратор", NormalizedName = "АДМИНИСТРАТОР", OwnerId = 1 },
                        new { Id = 2, ConcurrencyStamp = "d1118685-e2c3-441e-810d-1f0b0d37f1d5", CreateDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsSystem = true, LastModificationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "Главный врач", NormalizedName = "ГЛАВНЫЙ ВРАЧ", OwnerId = 1 }
                    );
                });
