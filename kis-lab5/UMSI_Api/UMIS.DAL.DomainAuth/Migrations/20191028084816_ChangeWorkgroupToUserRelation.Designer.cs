...
namespace UMIS.DAL.DomainAuth.Migrations
{
    ...
    [Migration("20191028084816_ChangeWorkgroupToUserRelation")]
    partial class ChangeWorkgroupToUserRelation
    {
            ...
            modelBuilder.Entity("UMIS.DAL.Domain.Contracts.Models.Auth.Role", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, ConcurrencyStamp = "e9df9826-4e15-4d92-b250-20b985d4c638", CreateDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsSystem = true, LastModificationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "Администратор", NormalizedName = "АДМИНИСТРАТОР", OwnerId = 1 },
                        new { Id = 2, ConcurrencyStamp = "e712d29d-5e2d-415c-b8d6-0e3d022527f6", CreateDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsSystem = true, LastModificationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), Name = "Главный врач", NormalizedName = "ГЛАВНЫЙ ВРАЧ", OwnerId = 1 }
                    );
                });
