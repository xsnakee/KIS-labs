...
namespace UMIS.DAL.DomainAuth.Migrations
{
    ...
    [Migration("20191127112618_changeRoleToWorkGroupDomainModel")]
    partial class changeRoleToWorkGroupDomainModel
    {
            ...
            modelBuilder.Entity("UMIS.DAL.Domain.Contracts.Models.Auth.RelationsEntityModels.RoleToWorkgroup", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, AllowedOnlyForOwner = false, CreateDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsRemoved = false, IsSystem = false, LastModificationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), OwnerId = 1, RoleId = 1, WorkgroupId = 1 },
                        new { Id = 2, AllowedOnlyForOwner = false, CreateDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), IsRemoved = false, IsSystem = false, LastModificationDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), OwnerId = 1, RoleId = 2, WorkgroupId = 1 }
                    );
                });
